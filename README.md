...
6) Click on your ecobee device again to get the 4-alphanumeric PIN  from the Events List under https://graph.api.smartthings.com/device/list. It should appear immediately under the verboseTrace attribute.
